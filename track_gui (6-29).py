...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        self.useJoystick_cb.useJoystickLabel = QtGui.QLabel(self.useJoystick_cb)
        self.useJoystick_cb.useJoystickLabel.setText("Degrees: ")
        self.useJoystick_cb.useJoystickLabel.setStyleSheet("QLabel { font-size: 12px; background-color:rgb(0,0,0); color:rgb(255,255,255); }")
        self.useJoystick_cb.useJoystickLabel.move(400,0)

        self.useJoystick_cb.useJoystickLabel.setText(".1")
        self.useJoystick_cb.useJoystickLabel.setStyleSheet("QLabel { font-size: 12px; background-color:rgb(255,255,255); color:rgb(0,0,0); }")
        self.useJoystick_cb.useJoystickLabel.move(450,0)
